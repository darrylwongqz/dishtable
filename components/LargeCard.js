  ...
  return (
    <section className="relative py-16 cursor-pointer">
      ...
      <div className="absolute top-32 left-12 ">
        ...
        <button className="px-6 py-2 mt-5 text-sm text-white transition duration-150 ease-out transform bg-red-600 rounded-lg hover:shadow-xl hover:font-semibold hover:scale-110 active:scale-90">
          {buttonText}
        </button>
      </div>
    </section>
